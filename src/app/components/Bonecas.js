...
import { Heart, Star, ShoppingCart, Info, ChevronLeft, ChevronRight } from "lucide-react"
...
function ImageCarousel({ images, alt }) {
  ...
  return (
    <div className="relative group">
      <Image
        src={images[currentImage] || "/placeholder.svg?height=400&width=400"}
        alt={alt}
        width={400}
        height={400}
  ...
  return (
    ...
    >
      <div className="relative">
        <ImageCarousel images={boneca.imgs} alt={boneca.name} />
        <Badge className="absolute top-2 left-2 bg-pink-500 hover:bg-pink-600 z-10">{boneca.highlight}</Badge>
        <div className="absolute top-2 right-2 bg-white/90 rounded-full p-2 z-10">
