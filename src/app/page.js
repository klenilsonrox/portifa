...
const projetos = [
  ...
  {id:2, name:"Pytter Burger", description:"Pytter Burger é um cardápio Online que fiz como freelancer para uma hamburgueria, através do site os usuários podem fazer o pedido, e enviar via Whatsapp, o que agiliza muito o atendimento para o dono do estabelecimento sem a necessidade de ficar perdendo tempo conversando com clientes.", image:"./images/pytter.png", link:"https://www.pytterburger.com.br" , tecnologias:["Nextjs","Tailwind"],color:"bg-[#000000]"},
  {id:3, name:"Nutri Ferraz", description:"Nutri Ferraz é um site para uma nutricionista Fictícia feito com NextJs e tailwind css!", image:"./images/nutri.png", link:"https://pagina-nutricionista.vercel.app/" , tecnologias:["Nextjs","Tailwind"],color:"bg-[#FED7B1]"},
  {id:4, name:"Rx Burgers", description:"Rx Burguers é um projeto fullstack de um sistema de administraçao de pedidos e clientes, o projeto foi feito usando Nextjs e tailwind no frontend, prisma, postgres no backend!", image:"./images/burgers.png", link:"https://hamburgueriarx.vercel.app" , tecnologias:["Nextjs","Tailwind","NodeJs","Prisma","express"],color:"bg-red-600"},
]
