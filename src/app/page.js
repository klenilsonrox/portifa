      ...
      <div className='bg-[#0E1013] text-white min-h-screen'>
        <main className="max-w-7xl mx-auto p-4">
          ...
          <section id="skills" className="my-12">
              ...
              <div className="flex justify-center space-x-4 px-4 overflow-x-scroll lg:overflow-x-auto">
          ...
          <section id="contact" className="my-12">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0 md:space-x-8">
                  ...
                  <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-4 md:w-1/2">
