...
function verFoto(){
  ...
  return (
    ...
    <button className='fixed right-4 z-10 top-4 lg:top-2 bg-white lg:right-2 shadow-neumorph rounded-full p-2' onClick={()=>setOnCv(false)}><IoMdClose className='text-2xl'/></button>
