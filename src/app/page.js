...
const Page = () => {
  return (
    ...
    <div className='flex inset-0 fixed justify-center bg-white border-2 bg-opacity-15 backdrop-blur-sm p-2 z-10'>
      <div className='shadow-neumorph bg-gradient-to-br overflow-auto lg:overflow-hidden flex flex-col lg:flex-row from-[#E2E8EC] gap-6 to-[#ffffff] rounded-lg w-full max-w-4xl'>
      <div className='bg-blue-400 p-2 lg:overflow-y-scroll scrollbar-blue w-full max-w-[400px]'>
        <img src="./images/eu.jpg" alt="" className='lg:w-[250px] lg:h-[250px] lg:rounded-full object-cover mx-auto' />
...
<li className='list-disc ml-4'>Boa gestão do tempo para priorizartarefas e cumprir prazos</li>
      ...
      <h1 className='text-[40px] font-bold text-blue-500 border-b-4 border-b-blue-500'> Clenilson Brandao</h1>
...
o código-fonte.</li>
    ...
    <div className='flex w-full max-w-7xl flex-col lg:flex-row mx-auto gap-10 p-4 lg:p-0'>
      <div className='lg:h-screen main lg:sticky top-0 flex items-center justify-center'>
        <div className='flex flex-col items-center lg:items-start gap-4 w-full max-w-2xl '>
          <img 
            src="https://png.pngtree.com/png-clipart/20220117/original/pngtree-flat-vector-cartoon-programmer-png-image_7147219.png" 
            alt=""  
            className='max-w-[150px] lg:mb-8 border-4 rounded-full border-white'
          />
          <p className='text-[31px] lg:text-[60px] font-bold lg:leading-10 leading-3 mt-2'>
          ...
          <p className='mt-2 p-2 lg:mt-6 lg:text-xl text-[#7D7F83]'>
            Sou o desenvolvedor web fullstack para uma #empresa em Bangladesh, OR. Tenho uma grande paixão por efeitos de UI, animações e criação de experiências de usuário intuitivas e dinâmicas.
          </p>
          <div className='flex gap-8 relative lg:mt-8'>
            <button className='bg-[#ECF0F3] text-[#FF014F] transition-all hover:bg-[#FF014F] hover:text-white relative hover:bottom-2 font-medium shadow-neumorph px-8 py-3 rounded-md'>
              Currículo
            </button>

            <Link href="https://wa.me/55031992311170?text=Olá,%20vim%20pelo%20seu%20portfólio" target='_blank' className='bg-[#ECF0F3] text-[#FF014F] transition-all hover:bg-[#FF014F] hover:text-white relative hover:bottom-2 font-medium shadow-neumorph px-8 py-3 rounded-md'>
              Contate-me
            </Link>
          </div>
        </div>
  ...
  <div className='shadow-neumorph bg-gradient-to-br from-[#E2E8EC] to-[#ffffff] rounded-lg p-6'>
    ...
    <p className='mt-6 text-[17px] text-[#3e3e3f]'>
...
<div className='w-full flex-1 mt-[60px] mb-10'>
  <div className='shadow-neumorph bg-gradient-to-br from-[#E2E8EC] to-[#ffffff] rounded-lg p-6'>
    ...
    <ul className='mt-6 flex flex-col gap-2 text-[17px] text-[#3e3e3f]'>
